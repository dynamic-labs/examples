  ...
  return (
    <div className="min-h-screen bg-[#0a0b0f] flex items-center justify-center px-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="relative bg-gradient-to-b from-[#12131a] to-[#0d0e14] border border-[#1f2937] rounded-3xl p-8 md:p-12 shadow-2xl">
          {/* Warning Icon */}
          ...
          {/* Divider */}
          <div className="w-full h-px bg-gradient-to-r from-transparent via-[#2a2b33] to-transparent mb-8" />
